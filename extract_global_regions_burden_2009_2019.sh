...
exp="ac3_arctic"
liste=$(ls -d ${base_path}/${exp}/2009-2019/${exp}_*.01_burden.nc)
...
cdo -timmean -mergetime tmp_${region}_emi_glb*.nc  PMOA_${region}_burden_mean_glb_annual_total_2009_2019.nc
cdo -timmean  -yearmean -mergetime [ -apply,-monmean [ tmp_${region}_emi_whole_grid_glb_*.nc ] ] PMOA_${region}_burden_mean_whole_grid_glb_annual_total_2009_2019.nc
