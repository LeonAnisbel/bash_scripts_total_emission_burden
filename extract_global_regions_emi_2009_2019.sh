...
cdo -timmean -mergetime tmp_emi_glb_yr*.nc  PMOA_${region}_emi_mean_glb_annual_total_2009_2019.nc
cdo -timmean  -yearmean -mergetime [ -apply,-monmean [ tmp_${region}_emi_whole_grid_glb_*.nc ] ] PMOA_${region}_emi_mean_whole_grid_glb_annual_total_2009_2019.nc
