...
cdo -timmean -yearmean -mergetime [ -apply,-monmean [ tmp_burden_glb_*.nc ] ] ${var}_burden_mean_glb_annual_total_2009_2019.nc

cdo -timmean -yearmean -mergetime [ -apply,-monmean [ tmp_burden_whole_grid_glb_*.nc ] ] ${var}_burden_mean_whole_grid_glb_annual_total_2009_2019.nc
